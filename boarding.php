<?php
	...
	$text = array(
		...
		"PHONE" => "Phone Number",
		"EMAIL" => "Email Address",
		"COMMENTS" => "Please let us know if this reservation is for more than one pet and any special requests",
		"DROPOFFDATE" => "Request Drop-Off Date",
		"PICKUPDATE" => "Request Pick-Up Date",
	...
	// List of required fields, possible values are: firstname, lastname, cellnumber, phonenumber, emailaddress, patientname, otherspecies, comments, pickupdate, dropoffdate.
	...
	if ($readyToSubmit) {	
		$emailbody = '
			Request boarding start date: ' . @$_POST["dropoffdate"] . ' 
			Boarding pick-up date: ' . @$_POST["pickupdate"] . ' 
...
?>		
	<div class="container">	
		<form role="form" method="post" action="">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="input-group date form_datetime" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dropoffdate">
						<input type="text" name="dropoffdate" class="form-control" placeholder="<?php echo $text['DROPOFFDATE']; ?>" <?php echo (in_array("dropoffdate",$requiredFields)?'required':''); ?> readonly/>
						<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
						<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
					</div>
				</div>
				<div class="col-md-6">
					<div class="input-group date form_datetime" data-date-format="dd MM yyyy - HH:ii p" data-link-field="pickupdate">
						<input type="text" name="pickupdate" class="form-control" placeholder="<?php echo $text['PICKUPDATE']; ?>" <?php echo (in_array("pickupdate",$requiredFields)?'required':''); ?> readonly/>
						<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
						<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
					</div>
				</div>
