<?php
	...
	// List of required fields, possible values are: firstname, lastname, cellnumber, phonenumber, emailaddress, petname, comments.
...
?>		
	<div class="container">		
		<form role="form" method="post" action="">
			...
			<input type="text" name="petname" class="form-control" placeholder="<?php echo $text['PETNAME']; ?>" <?php echo (in_array("petname",$requiredFields)?'required':''); ?>/>
